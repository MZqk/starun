...
interface FuzzyTextProps {
  ...
  className?: string;
  /** Accessible label for the canvas element (required for screen readers). */
  ariaLabel?: string;
}
...
const FuzzyText: React.FC<FuzzyTextProps> = ({
  ...
  useEffect(() => {
    ...
    // Respect prefers-reduced-motion: draw a single static frame, skip rAF loop.
    ...
    const init = async () => {
      ...
      if (glitchMode && !prefersReducedMotion) startGlitchLoop();

      // If reduced motion is preferred, draw one static frame and stop.
