...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas) {
      ...
      let finalHalfFloatTexType = halfFloatTexType;
      // Fallback to standard 8-bit unsigned byte formats if half float is not supported/renderable
      if (formatRGBA == null || formatRG == null || formatR == null) {
        finalHalfFloatTexType = gl.UNSIGNED_BYTE;
      ...
      return {
        ...
        ext: {
          ...
          formatRG,
          formatR,
          halfFloatTexType: finalHalfFloatTexType,
    ...
    return () => {
      ...
      // Force WebGL context loss to free all GPU resources and prevent memory leak
      if (ext && ext.loseContextExt) {
        ext.loseContextExt.loseContext();
      }
