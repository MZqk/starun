...
from app.agent_sdk.bridge import _supports_image_input
...
def test_deepseek_chat_completions_use_text_only_input() -> None:
    assert not _supports_image_input("https://api.deepseek.com/v1")
    assert not _supports_image_input("https://proxy.deepseek.com/v1")
    assert _supports_image_input("https://api.moonshot.cn/v1")
